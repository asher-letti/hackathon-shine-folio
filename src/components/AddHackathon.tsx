...
import { Trophy, ArrowLeft, Plus, X, Calendar, Users, Code, Link as LinkIcon } from 'lucide-react';
...
const AddHackathon = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const existingHackathons = JSON.parse(localStorage.getItem('hackfolio_hackathons') || '[]');
      ...
      toast({
        title: "Success!",
        description: "Hackathon added to your portfolio",
      });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      ...
      <div className="max-w-3xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Add New Hackathon</h1>
          <p className="text-gray-600">
            Showcase your hackathon achievement and add it to your portfolio
          </p>
        </div>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border-purple-100 shadow-xl">
          <CardHeader>
            ...
            <CardDescription>
              Fill in the details about your hackathon participation
            </CardDescription>
          </CardHeader>
